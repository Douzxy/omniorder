      ...
      <div className="min-h-screen bg-[#fafafa] flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center px-4 py-8">
          <div className="w-full max-w-sm text-center space-y-4">
            ...
            <h2 className="font-extrabold text-neutral-900 text-lg">Tautan Dikirim!</h2>
            <p className="text-xs text-neutral-500 leading-relaxed">
              Cek email <strong>{email}</strong>. Klik tautan masuk yang kami kirim untuk login otomatis.
            </p>
            <p className="text-[10px] text-neutral-400">
              Tidak menerima? Cek folder spam atau{" "}
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] flex flex-col">
      <header className="sticky top-0 z-40 bg-white border-b border-neutral-200/50 px-4 py-4 flex items-center gap-4">
        ...
        <h1 className="font-extrabold text-neutral-900 text-lg">Masuk Akun</h1>
      </header>
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-sm space-y-6">
          <div className="text-center">
            ...
            <h2 className="font-extrabold text-neutral-900 text-xl">Masuk via Email</h2>
            <p className="text-xs text-neutral-500 mt-1">
              Kami kirim tautan login ke email Anda
            </p>
          </div>
